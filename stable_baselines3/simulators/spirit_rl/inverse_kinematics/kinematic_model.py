...
class robotKinematics:
  ...
  def solve(self, orn, pos, bodytoFeet):
    ...
    FR_angles = solve_R(_FRcoord, self.coxa, self.femur, self.tibia)
    FL_angles = solve_L(_FLcoord, self.coxa, self.femur, self.tibia)
    BR_angles = solve_R(_BRcoord, self.coxa, self.femur, self.tibia)
    BL_angles = solve_L(_BLcoord, self.coxa, self.femur, self.tibia)
