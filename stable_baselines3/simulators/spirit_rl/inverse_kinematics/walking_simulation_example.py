...
for i in range(100000):
  ...
  p.setJointMotorControl2(
      boxId, 0, p.POSITION_CONTROL, targetPosition=FL_angles[0], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 1, p.POSITION_CONTROL, targetPosition=FL_angles[1], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 2, p.POSITION_CONTROL, targetPosition=FL_angles[2] + 3.14, force=maxForce, maxVelocity=maxVel
  )

  p.setJointMotorControl2(
      boxId, 4, p.POSITION_CONTROL, targetPosition=BL_angles[0], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 5, p.POSITION_CONTROL, targetPosition=BL_angles[1], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 6, p.POSITION_CONTROL, targetPosition=BL_angles[2] + 3.14, force=maxForce, maxVelocity=maxVel
  )

  p.setJointMotorControl2(
      boxId, 8, p.POSITION_CONTROL, targetPosition=FR_angles[0], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 9, p.POSITION_CONTROL, targetPosition=FR_angles[1], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 10, p.POSITION_CONTROL, targetPosition=FR_angles[2] + 3.14, force=maxForce, maxVelocity=maxVel
  )

  p.setJointMotorControl2(
      boxId, 12, p.POSITION_CONTROL, targetPosition=BR_angles[0], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 13, p.POSITION_CONTROL, targetPosition=BR_angles[1], force=maxForce, maxVelocity=maxVel
  )
  p.setJointMotorControl2(
      boxId, 14, p.POSITION_CONTROL, targetPosition=BR_angles[2] + 3.14, force=maxForce, maxVelocity=maxVel
  )
