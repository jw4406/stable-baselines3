...
class my_AntEnv(MujocoEnv, utils.EzPickle):
    r"""
    ## Description
    ...
    * v0: Initial versions release
    ...
    def step(self, action):
        ...
        #self.data.xfrc_applied[0, 3:] = [0.0, 0.0, 0.0]  # No torque
        #self.contact_forces[0, 0:3] += force
        #    print("extraneous contact forces")
