...
model = A2C.load("/Users/jw4406/Downloads/Walker2d-v3.zip", env=env)
...
eval_callback = EvalCallback(env, callback_on_new_best=callback_on_best, verbose=1, eval_freq=8)
#checkpoint_callback = CheckpointCallback(
#  save_freq=10,
#  save_path="./logs/",
#  name_prefix="stac_pend_model",
#  save_replay_buffer=True,
#  save_vecnormalize=True,
#)
#callback_list = CallbackList([eval_callback, checkpoint_callback])
model.learn(total_timesteps=5_000_000, callback=eval_callback)#, callback=callback_list)
