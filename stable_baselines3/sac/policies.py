...
class SAACPolicy(BasePolicy):
    ...
    def __init__(
        ...
        if net_arch is None:
            net_arch = {'pi':[128,128,128], 'qf':[128,128,128]}
        ...
        self.actor_kwargs = self.net_args.copy()
        self.dstb_actor_kwargs = self.dstb_net_args.copy()
        sde_kwargs = {
            "use_sde": use_sde,
            "log_std_init": log_std_init,
            "use_expln": use_expln,
        ...
        self.actor_kwargs.update(sde_kwargs)
        self.dstb_actor_kwargs.update(sde_kwargs)
        self.critic_kwargs = self.net_args.copy()
        self.critic_kwargs.update(
            {
                "n_critics": n_critics,
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        self.dstb_actor.optimizer = self.optimizer_class(
            self.dstb_actor.parameters(),
            lr=lr_schedule[2](1),  # type: ignore[call-arg]
            **self.optimizer_kwargs,
        )
    ...
    def make_dstb_actor(self, features_extractor: Optional[BaseFeaturesExtractor] = None) -> Actor:
