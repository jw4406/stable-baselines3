...
import imageio
model_path = "/home/jw4406/codebase/stable-baselines3/stable_baselines3/main/trained_models/tasks/todo/my_half_cheetah_ego_2.0_adv_0.5_10500000_steps.task"
...
while not done:
    ...
    env.render()
env.close()
imageio.mimsave("my_ant.gif", [img for img in img], fps=29)
